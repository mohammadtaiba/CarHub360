...
public class MaintenanceTest {
    ...
    public void setUp() {
        ...
        maintenance = new Maintenance(1, vehicle, startDate, endDate, cost, description);
    ...
    public void testAddMaintenance() {
        ...
        assertTrue(maintenanceManager.addMaintenance(1, vehicle, startDate, endDate, cost, description));
    }
    ...
    public void testAddMaintenanceInvalidVehicle() {
        ...
        assertFalse(maintenanceManager.addMaintenance(2, null, startDate, endDate, cost, description));
    }
    ...
    public void testGetMaintenanceDetails() {
        ...
        maintenanceManager.addMaintenance(1, vehicle, startDate, endDate, cost, description);

        String details = maintenanceManager.getMaintenanceDetails(1);
    ...
    public void testGetMaintenanceDetailsNotFound() {
        String details = maintenanceManager.getMaintenanceDetails(999);
        assertNotNull(details);
    ...
    public void testDefaultConstructor() {
        Vehicle vehicle = new Vehicle(1, "Model S", "Tesla", 50000, 2021, "Sedan");
        Date startDate = new Date();
        Date endDate = new Date();
        float cost = 200.0f;
        String description = "Battery replacement";

        Maintenance m = new Maintenance(1, vehicle, startDate, endDate, cost, description);
